...
| SEC-18 Erros/logs | Codigo reforcado; operacao pendente | Engenharia/Infra TBD | 500 mascarado em prod; erro bruto nao logado; secrets redigidos em audit payload | `errorHandler.test.ts`, `authMiddleware.test.ts`, `auth.test.ts`, `evidence/2026-07-16-etapa-1.md` | Logger estruturado, request ID, alertas e retencao. |
