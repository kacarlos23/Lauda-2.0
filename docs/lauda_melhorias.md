...
# Tarefas de Execução (Ordem Obrigatória)
...
- [ ] Badge "Líder" aparece corretamente para `isLeader: true`
...
3. **Armadilhas comuns** e como evitá-las (ex: race condition no refresh)
